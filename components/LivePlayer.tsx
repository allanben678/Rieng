...
export default function LivePlayer() {
  ...
  useEffect(() => {
    ...
    if (hour >= 5 && hour < 10) {
      ...
      setCurrentShow({ title: 'Reggae / Dancehall', host: 'inkmatic', image: 'https://dkmdvhzdixefykoojhgt.supabase.co/storage/v1/object/sign/Mp3/Updated_Artist.jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV81NTUxYTk2MC04YjVhLTRkNjEtOTJkMS1jMjVkNWNlY2IxMDMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJNcDMvVXBkYXRlZF9BcnRpc3QuanBnIiwiaWF0IjoxNzc4ODI3MzM0LCJleHAiOjE4MTAzNjMzMzR9.UiaGD8ngpxpAgDY3I3cP9K1zwZ7n6hbR4A6fIqs4t2E' })
