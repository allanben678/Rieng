...
export default function LivePlayer() {
  ...
  useEffect(() => {
    ...
    if (hour >= 5 && hour < 10) {
      ...
      setCurrentShow({ title: 'Gengetone / Arbantone', host: 'RIENG Radio', image: 'https://dkmdvhzdixefykoojhgt.supabase.co/storage/v1/object/sign/Mp3/UpdatedShows/Gengetone.jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV81NTUxYTk2MC04YjVhLTRkNjEtOTJkMS1jMjVkNWNlY2IxMDMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJNcDMvVXBkYXRlZFNob3dzL0dlbmdldG9uZS5qcGciLCJpYXQiOjE3Nzg4NjQ1NDksImV4cCI6MTgxMDQwMDU0OX0.oNH6E5Rn6OXIvquWSBtfFFVUB6aT9U0F_5Shbu0P7dI' })
